...
const accentClasses: Record<NonNullable<LiveCardProps['accentColor']>, string> = {
  ...
  blue: 'border-blue-400/70 hover:border-blue-500 shadow-[0_0_0_1px_rgba(96,165,250,0.25),0_8px_30px_-12px_rgba(96,165,250,0.5)] hover:shadow-[0_0_0_1px_rgba(96,165,250,0.45),0_12px_40px_-10px_rgba(96,165,250,0.65)]',
  green:
