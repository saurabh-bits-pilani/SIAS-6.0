...
const FAQ_DATA: readonly FaqItem[] = [
  {
    ...
    a: (
      <>
        Vrishabha Rashi (Taurus) is the second sign of the Vedic sidereal zodiac, spanning 30 to 60
        degrees. It is a <strong style={{ color: '#d97706' }}>fixed earth sign</strong> ruled by{' '}
        <strong style={{ color: '#d97706' }}>Shukra (Venus)</strong>, the planet of beauty, comfort,
        and material abundance. Natives with the Moon in Vrishabha are known for their steadiness,
        sensual nature, and deep love of beauty in all forms.
      </>
    ),
    aText:
      'Vrishabha Rashi (Taurus) is the second sign of the Vedic sidereal zodiac, spanning 30 to 60 degrees. It is a fixed earth sign ruled by Shukra (Venus), the planet of beauty, comfort, and material abundance. Natives with the Moon in Vrishabha are known for their steadiness, sensual nature, and deep love of beauty in all forms.',
  },
  {
    ...
    a: (
      <>
        Shukra (Venus) is the ruling planet of Vrishabha Rashi. Venus governs beauty, art, music,
    ...
    aText:
      'Shukra (Venus) is the ruling planet of Vrishabha Rashi. Venus governs beauty, art, music, romance, luxury, wealth, vehicles, and the pleasures of life. A strong Venus in the chart amplifies artistic talent, financial acumen, and romantic fulfilment. A weak or afflicted Venus can bring indulgence, attachment, and relationship difficulties.',
  },
  {
    ...
    a: (
      <>
        Vrishabha natives are patient, dependable, and deeply sensual. They build slowly but build
        to last, whether in relationships, finances, or creative work. Their greatest challenge is
        resistance to change and possessiveness. When their stubbornness is redirected into
        persistence, Vrishabha energy produces remarkable, enduring results.
      </>
    ),
    aText:
      'Vrishabha natives are patient, dependable, and deeply sensual. They build slowly but build to last, whether in relationships, finances, or creative work. Their greatest challenge is resistance to change and possessiveness. When their stubbornness is redirected into persistence, Vrishabha energy produces remarkable, enduring results.',
  },
  {
    ...
    a: (
      <>
        Diamond (Heera) or White Sapphire (Safed Pukhraj) are the classical gemstones for Vrishabha
        Rashi, worn to strengthen Shukra (Venus). Diamond should be set in silver or platinum and
        worn on the middle finger of the right hand on a Friday morning after proper mantra
        invocation. A chart-based consultation with a qualified jyotishi at Soul Infinity Astro
        Solutions is essential before wearing any planetary gemstone.
      </>
    ),
    aText:
      'Diamond (Heera) or White Sapphire (Safed Pukhraj) are the classical gemstones for Vrishabha Rashi, worn to strengthen Shukra (Venus). Diamond should be set in silver or platinum and worn on the middle finger of the right hand on a Friday morning after proper mantra invocation. A chart-based consultation with a qualified jyotishi at Soul Infinity Astro Solutions is essential before wearing any planetary gemstone.',
  },
  {
    ...
    a: (
      <>
        Friday is the most auspicious day for Vrishabha Rashi natives, governed by Shukra (Venus).
        Green, white, and pink are the lucky colours that resonate with Venus energy. Fasting on
        Fridays, visiting Lakshmi or Devi temples, and wearing green or white on important
        occasions are traditional practices that support Vrishabha natives in channelling Venus
        energy constructively.
      </>
    ),
    aText:
      'Friday is the most auspicious day for Vrishabha Rashi natives, governed by Shukra (Venus). Green, white, and pink are the lucky colours that resonate with Venus energy. Fasting on Fridays, visiting Lakshmi or Devi temples, and wearing green or white on important occasions are traditional practices that support Vrishabha natives in channelling Venus energy constructively.',
  },
];
...
export default function VrishabhaRashiPage() {
  ...
  return (
    <>
      ...
      <SchemaMarkup
        type="webpage"
        webPage={{
          name: 'Vrishabha Rashi (Taurus) in Vedic Astrology',
          description:
            'Vrishabha Rashi, the second sign of the Vedic zodiac, ruled by Shukra (Venus). Personality, mantra, remedies, and houses placement.',
          url: '/zodiac/taurus',
        }}
        breadcrumbs={[
          { name: 'Home', url: '/' },
      ...
      <div className="w-full bg-gray-900">
        <img
          src={HERO_URL}
          alt="Vrishabha Rashi hero banner showing Taurus Vedic astrology symbolism for Soul Infinity"
      ...
      <div>
        ...
        <section className="bg-white pt-2 pb-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <p className="text-sm md:text-base tracking-[0.25em] uppercase text-green-700 font-semibold mb-2">
              <span className="font-devanagari" lang="sa">वृषभ राशि</span>
            ...
            <h1 className="font-heading font-bold text-3xl md:text-5xl text-gray-900 mb-2 leading-tight">
              Vrishabha Rashi, The Builder of the Zodiac
            </h1>
        ...
        {/* Section 3, About Vrishabha. Two-column infographic. */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-5 space-y-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0 bg-green-100 text-green-700">
                ...
                {/* Card 1, intro */}
                <div className="bg-white p-4 rounded-xl flex gap-3" style={{ border: '1px solid #bbf7d0' }}>
                  <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0 bg-green-100 text-green-700">
                    <Gem className="w-5 h-5" aria-hidden="true" />
                  </div>
                  <p className="text-sm text-gray-700 leading-relaxed m-0">
                    Vrishabha (Taurus) is the <strong style={{ color: '#d97706' }}>second sign</strong> of
                    the Vedic zodiac, ruled by Shukra (Venus), the planet of beauty, abundance, and
                    earthly pleasures. As a <strong>fixed earth sign</strong>, Vrishabha carries the
                    energy of consolidation, the force that takes what Mesha initiated and builds it
                ...
                <div className="bg-white p-4 rounded-xl flex gap-3" style={{ border: '1px solid #bbf7d0' }}>
                  ...
                  <div>
                    <h3 className="font-heading font-bold text-base mb-1" style={{ color: '#15803d' }}>
                      The Builder
                    </h3>
                    <p className="text-sm text-gray-700 leading-relaxed m-0">
                      In the Brihat Parashara Hora Shastra, Vrishabha is described as a{' '}
                      <strong>Vaishya sign</strong>, associated with trade, prosperity, and the art of
                      creating wealth from the earth&apos;s bounty.
                    </p>
                  </div>
                </div>

                {/* Card 3, Sensual and Devoted */}
                <div className="bg-white p-4 rounded-xl flex gap-3" style={{ border: '1px solid #bbf7d0' }}>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed m-0">
                      The Bull moves slowly but with absolute certainty. Vrishabha natives do not
                      rush toward goals; they <strong style={{ color: '#d97706' }}>accumulate</strong>,
                      layer by layer, until what they have built is unshakeable.
                    </p>
                  </div>
                </div>

                {/* Card 4, Born to Endure */}
                <div className="bg-white p-4 rounded-xl flex gap-3" style={{ border: '1px solid #bbf7d0' }}>
                  <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0 bg-green-100 text-green-700">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed m-0">
                      Where Mesha acts on instinct, Vrishabha acts on{' '}
                      <strong>conviction</strong>. Once a Vrishabha native commits to a path, very
                      few forces in the world can redirect them.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl flex gap-3" style={{ background: '#dcfce7', border: '1px solid #86efac' }}>
                  <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0 bg-green-200 text-green-800">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed m-0 italic">
                      At Soul Infinity Astro Solutions, Saurabh Jain observes that Vrishabha
                      ascendants and Moon sign natives often arrive at decisions requiring patience,
                      and their chart invariably shows the planetary support for slow, deliberate
              ...
              <div className="lg:col-span-7 space-y-4">
                ...
                <div className="bg-white p-4 rounded-xl" style={{ border: '1px solid #bbf7d0' }}>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-700 leading-relaxed m-0">
                        ...
                        <strong>art and music</strong>, <strong>vehicles</strong>,{' '}
                        <strong>luxury</strong>, <strong>romance</strong>, and{' '}
                        <strong>wealth</strong> in Vedic astrology.
                      </p>
                    </div>
                    <div className="hidden md:flex flex-col gap-1.5 text-green-700/70 pt-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                    <div className="md:col-span-2 flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700 leading-relaxed m-0">
                          A well-placed Venus in a Vrishabha chart amplifies{' '}
                          <strong style={{ color: '#d97706' }}>artistic talent</strong>, financial
                          acumen, and the capacity to build enduring relationships.
                        </p>
                      </div>
                    </div>
                    <div className="rounded-lg p-3" style={{ background: '#f0fdf4', border: '1px solid #86efac' }}>
                      <p className="text-xs leading-relaxed m-0 italic" style={{ color: '#065f46' }}>
                        An afflicted Venus can bring indulgence, possessiveness, and an excessive
                ...
                <div className="bg-white p-4 rounded-xl flex gap-3" style={{ border: '1px solid #bbf7d0' }}>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed m-0">
                      ...
                      central to reading a Vrishabha chart accurately.
                    </p>
                  </div>
                </div>

                {/* Vimshottari Dasha card */}
                <div className="bg-white p-5 rounded-xl" style={{ border: '1px solid #bbf7d0' }}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700 leading-relaxed">
                    <p className="m-0">
                      In the Vimshottari Dasha system, Vrishabha natives often experience{' '}
                      <strong style={{ color: '#d97706' }}>twenty-year Venus Mahadasha</strong>{' '}
                      cycles that profoundly shape their material and aesthetic life.
                    </p>
                    <p className="m-0">
                      The sign itself spans the last three padas of <strong>Krittika</strong>,
                      all of <strong>Rohini</strong>, and the first two padas of{' '}
                      <strong>Mrigashira</strong> nakshatras.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-4">
                    ...
                    <div className="text-center p-3 rounded-lg" style={{ background: '#dcfce7', border: '1px solid #86efac' }}>
                      ...
                      <div className="font-heading font-bold text-sm text-green-700">Rohini</div>
                      <div className="text-xs text-gray-600 mt-1">Beauty and growth</div>
                    </div>
      ...
      >
        ...
        <div className="relative w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center text-white">
          ...
          <div className="text-sm md:text-base text-gray-200 mb-6 max-w-xl mx-auto">
            Salutation to Shukra (Venus), the planet of beauty and abundance, ruler of Vrishabha Rashi.
          </div>
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p
              ...
              style={{ fontSize: '14px' }}
            >
              The patient earth within, strengths that build legacy and challenges that test resolve.
            </p>
          </div>
          ...
          >
            ...
            <Gem size={18} color="#15803d" aria-hidden="true" />
            <p style={{ fontSize: '14px', color: '#374151', margin: 0 }}>
              When guided with awareness, the patience of Vrishabha becomes a{' '}
      ...
      {/* Section 6, Vrishabha in the 12 Houses. */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-heading font-bold text-3xl md:text-5xl mb-3 leading-tight">
              <span style={{ color: '#15803d' }}>Vrishabha</span>
            ...
            <div
              ...
              style={{ color: '#d97706' }}
            >
              How the Earth of Vrishabha Grounds Each Bhava
            </div>
          ...
          <div className="mt-10 text-center">
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              />
              <Gem className="w-4 h-4" style={{ color: '#15803d' }} aria-hidden="true" />
              <div
                className="h-px w-10"
                style={{ background: '#d97706', opacity: 0.4 }}
              />
            ...
            <p className="text-sm text-gray-700 italic">
              Vrishabha earth stabilizes every house it touches, bringing{' '}
      ...
      {/* Section 7, Remedies. JSX card grid on dark green (no bg image yet). */}
        ...
        <div className="max-w-5xl mx-auto relative">
          <div className="text-center mb-10">
            <h2 className="font-heading font-bold text-3xl md:text-4xl mb-3 leading-tight" style={{ color: 'white' }}>
              Classical Vedic Remedies for Vrishabha Rashi
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { main: 'Chant the Shukra Beej mantra (Om Shum Shukraya Namah)', sub: '108 times on Friday mornings', highlight: 'Shukra Beej mantra' },
              { main: 'Wear Diamond (Heera) or White Sapphire set in silver or platinum', sub: 'on the middle finger of the right hand, only after a chart-based recommendation', highlight: 'Diamond (Heera) or White Sapphire' },
              { main: 'Donate white sweets, white cloth, rice, or white flowers', sub: 'on Fridays at a Lakshmi or Devi temple', highlight: 'white sweets, white cloth' },
              { main: 'Recite the Shukra Stotra or Lakshmi Ashtakam on Fridays', sub: 'for harmony in relationships and financial growth', highlight: 'Shukra Stotra or Lakshmi Ashtakam' },
              ...
              { main: 'Cultivate artistic skills: music, painting, gardening, or any Venusian craft', sub: 'as a conscious practice that channels Shukra energy constructively', highlight: 'music, painting, gardening' },
              { main: 'Reduce excessive sugar, dairy, and overindulgence in comfort', sub: 'during Venus-afflicted periods. Cultivate non-attachment to material comfort', highlight: 'Reduce excessive sugar, dairy' },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <div className="relative max-w-3xl mx-auto">
          <div className="text-center mb-2">
            ...
            <p className="text-gray-600 text-base">
              Your top questions about Vrishabha Rashi, answered with clarity
            </p>
          </div>
                    ...
                    >
                      {faq.showImage ? (
                        <div className="flex flex-col md:flex-row items-start gap-5">
                          ...
                          <img
                            src={CARD_URL}
                            alt="Vrishabha Rashi Bull zodiac symbol Soul Infinity"
                            width={120}
                            height={120}
                            loading="lazy"
                            style={{
      ...
      <section className="py-20 bg-gradient-to-r from-green-900 to-emerald-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-heading font-bold text-3xl md:text-4xl mb-6">
            Want a Personalised Vrishabha Reading?
          </h2>
          <p className="text-xl text-green-100 mb-8 leading-relaxed">
            Saurabh Jain at Soul Infinity Astro Solutions reads Vrishabha placement in the context
