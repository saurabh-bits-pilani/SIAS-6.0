      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-lg text-gray-700 max-w-3xl mx-auto">
            ...
            specific life areas — marriage, career, family, and longevity. Understanding your
      ...
      <section className="py-16 bg-surface">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg text-gray-700">
          ...
          <p>
            ...
            restore balance — mantra practice, chart-specific fasting, gemstone therapy, puja,
          ...
          <p>
            Mangal Dosha (Manglik) involves Mars in certain houses (1, 2, 4, 7, 8, 12 counted from
            Lagna, Moon, or Venus) and has long been associated with challenges in marriage —
            delayed union, conflict, or health concerns for the spouse. Kaal Sarp Dosh is formed
            when all seven classical planets are hemmed between Rahu and Ketu, often experienced
            as waves of obstruction followed by breakthrough. Sade Sati — the seven-and-a-half-year
            transit of Saturn over natal Moon and the houses adjacent to it — is a slow-burning
            period of restructuring, karmic reckoning, and, for those who endure it consciously,
            deep growth. Pitru Dosh reflects unresolved ancestral karma, often activated during
            Pitru Paksha and addressed through specific tarpan and charity rituals. Nadi Dosh is a
            matching-chart concern in horoscope compatibility analysis.
          </p>
          <p>
            ...
            Infinity reading is always paired with its intensity, the likely trigger periods, and a
            concrete, phased remedial plan. This hub will expand into dedicated pillar pages for
            each of the five doshas above — covering origins, the charts most prone to them,
