  ...
  return (
    <div className="bg-white">
      <SEOHead
        ...
        description="Explore the nine planets (Navagraha) of Vedic astrology with Saurabh Jain (K.N. Rao Institute of Vedic Astrology). Dedicated guides for Sun, Moon, Mars, Mercury, Jupiter, Venus, Saturn, Rahu, and Ketu — mythology, behaviour, dasha effects, and remedies."
      ...
      <Breadcrumbs
        items={[{ label: 'Home', href: '/' }, { label: 'Planets' }]}
      />
      ...
      <section className="py-16 bg-surface">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg text-gray-700">
          ...
          <p>
            ...
            every chart interpretation. The system, rooted in the Brihat Parashara Hora Shastra and
            refined across centuries of lineage teaching, treats each planet as a sentient energy
            that inscribes karma into the fabric of an individual life. The Sun (Surya) governs
            identity, authority, and the soul's intent; the Moon (Chandra) rules the mind, emotion,
            and the moment-to-moment current of feeling. Mars (Mangal) sharpens courage and drive,
            Mercury (Budh) shapes language and intellect, Jupiter (Guru) expands wisdom and
            benevolence, Venus (Shukra) orchestrates love and aesthetic sense, and Saturn (Shani)
            enforces discipline, delay, and karmic accountability. The two shadow planets — Rahu
            and Ketu — map the lunar nodes, the points where the Moon's orbit intersects the
            ecliptic; they carry the weight of past-life desires (Rahu) and of release, liberation,
            and prior mastery (Ketu).
          </p>
          <p>
            ...
            amplification, and the remedies — mantra, meditation, gemstone, charity — that can
            harmonise a difficult influence.
          </p>
          <p>
            Use this hub as your starting point. Detailed Soul Infinity pillar pages for each of
            the nine planets are on the way — each will cover mythology, behavioural signatures,
            dasha effects, and practical remedies drawn from both classical texts and Saurabh's
