...
export default function ZodiacHubPage() {
  return (
    <div className="bg-white">
      ...
      <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Zodiac Signs' }]} />
      ...
      <section className="py-16 bg-surface">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 font-inter prose prose-lg text-gray-700">
          ...
          <p>
            The signs alternate in qualities (fire, earth, air, water) and in modality: cardinal
            (chara), fixed (sthira), and mutable (dwisvabhava). Leo (Simha) is a fixed fire sign
            ruled by the Sun; its energy is radiant, sovereign, and benevolently proud. Virgo
            (Kanya) is a mutable earth sign ruled by Mercury; its intelligence is pragmatic and
            detail-oriented. Capricorn (Makar) is a cardinal earth sign ruled by Saturn; it
            builds enduring structure through patience and discipline. Each rashi lives in
            relation to the others, and oppositions, sextiles, and trines shape the behavioural
