#!/usr/bin/env node
/**
 * One-off: convert + upload 4 Vrishabha (Taurus) Rashi assets to R2.
 * Source dir: assets-to-upload/Taurus
 * Target path: /Zodiac/Tarus/<filename>.webp (typo "Tarus" preserved per brief)
 */
...
const SRC_DIR = path.join(ROOT, 'assets-to-upload', 'Taurus');
const OUT_DIR = path.join(ROOT, 'assets-to-upload', '.optimized', 'Taurus');
const R2_PREFIX = 'Zodiac/Tarus';

const PLAN = [
  {
    role: 'hero',
    src: 'hero-banner-Taurus-rashi.png',
    out: 'hero-banner-vrishabha-rashi.webp',
    maxBytes: 400 * 1024,
    maxWidth: 1600,
    maxHeight: null,
  },
  {
    role: 'quick-facts',
    src: 'Taraus Rashi Quick Facts Strip.png',
    out: 'quick-facts-vrishabha-rashi.webp',
    maxBytes: 400 * 1024,
    maxWidth: 1600,
    maxHeight: null,
  },
  {
    role: 'mantra-bg',
    src: 'mantra-background-taurus.png',
    out: 'mantra-bg-vrishabha-rashi.webp',
    maxBytes: 400 * 1024,
    maxWidth: 1600,
    maxHeight: null,
  },
